...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { category_id: @tip.category_id, content: @tip.content, image: @tip.image, shown: @tip.shown }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { category_id: @tip.category_id, content: @tip.content, image: @tip.image, shown: @tip.shown }
    assert_redirected_to tip_path(assigns(:tip))
  end
