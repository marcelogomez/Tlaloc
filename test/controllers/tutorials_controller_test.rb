...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { category_id: @tutorial.category_id, description: @tutorial.description, name: @tutorial.name }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { category_id: @tutorial.category_id, description: @tutorial.description, name: @tutorial.name }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
